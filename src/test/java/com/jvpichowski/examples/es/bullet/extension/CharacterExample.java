 ...
 *
 */
public class CharacterExample extends SimpleApplication {

    public static void main(String[] args) {
        EntityData entityData = new DefaultEntityData();
        CharacterExample app = new CharacterExample(entityData, new Node());
        app.start();
    }
    ...
    public CharacterExample(EntityData entityData, Node root){
