 ...
 */
public class ESBulletInputExample extends SimpleApplication {

    public static void main(String[] args) {
        EntityData entityData = new DefaultEntityData();
        ESBulletInputExample app = new ESBulletInputExample(entityData);
        app.start();
    }

    private final EntityData entityData;

    public ESBulletInputExample(EntityData entityData){
